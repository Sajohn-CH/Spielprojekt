...
public class DeactivationTower extends Tower{
    ...
    public DeactivationTower (Vector3f location, Vector3f up){
        ...
        this.setLiving(true);
        for(int i = 0; i < getShootAtBombsClass().size(); i++){
            if(!this.canShootAtBombsClass(getShootAtBombsClass().get(i))){
                getShootAtBombsClass().remove(i);
            }
        }
    ...
    public void setLevel(int newLevel) {
        ...
        this.setShotsPerSecond(getNewSPS(newLevel)*multiplier);
